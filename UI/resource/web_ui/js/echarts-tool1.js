...
function createDynChart() {
	// var my_DynChart = document.getElementById('my_DynChart');
	// var myChart = echarts.init(my_DynChart, {
	//   renderer: 'canvas',
	//   useDirtyRect: false
	// });

	var myChart = echarts.init(document.getElementById('my_DynChart'));
...
function createMap() {
	...
	// var dom = document.getElementById('myMap');
